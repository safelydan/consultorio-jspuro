...
class ConsultasController {
    ...
    agendarConsulta(paciente, data, horaInicial, horaFinal) {
        ...
        console.log(`Consulta agendada para ${paciente.nome} no dia ${data}, das ${horaInicial} às ${horaFinal}.`);
    }

    listarConsultas() {
        console.log("Lista de Consultas Agendadas:");
        this.listaConsultas.forEach(consulta => {
            console.log(`Paciente: ${consulta.paciente.nome}, Data: ${consulta.data}, Hora Inicial: ${consulta.horaInicial}, Hora Final: ${consulta.horaFinal}`);
        });
    }
}
